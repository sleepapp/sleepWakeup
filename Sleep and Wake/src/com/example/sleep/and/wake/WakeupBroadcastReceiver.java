...
//         context.startActivity(myintent);
 ...
 public void SetAlarm(Context context,WakeupPanel mywakeup)
    {
        mywakeup.wakeupalarmmanager = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);
        //mywakeup.wakeupintent = new Intent(context, WakeupBroadcastReceiver.class);
        mywakeup.wakeupintent.putExtra(ONE_TIME, Boolean.FALSE);
        mywakeup.pendingintent = PendingIntent.getBroadcast(context, mywakeup.id, mywakeup.wakeupintent, 0);
        //After after 5 seconds
        mywakeup.wakeupalarmmanager.setRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis(), 1000 * 10 , mywakeup.pendingintent);
    }
    ...
    public void CancelAlarm(Context context,WakeupPanel mywakeup)
    {
        ...
        mywakeup.pendingintent = PendingIntent.getBroadcast(context, mywakeup.id, mywakeup.wakeupintent, 0);
        mywakeup.wakeupalarmmanager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        mywakeup.wakeupalarmmanager.cancel(mywakeup.pendingintent);
    }
    ...
    public void setOnetimeTimer(Context context, WakeupPanel mywakeup)
    {
        ...
        mywakeup.pendingintent = PendingIntent.getBroadcast(context, mywakeup.id, mywakeup.wakeupintent, 0);
        mywakeup.wakeupalarmmanager.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis(), mywakeup.pendingintent);
    }
}